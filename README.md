...
regions of definite roots if found and outputs a list of <b><i>exact rational box coordinates where definitely roots lie within</b></i> into the log text file `_subdiv-core.log`.
